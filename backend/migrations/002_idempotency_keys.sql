...
CREATE UNIQUE INDEX idx_unique_idempotency_keys ON idempotency_keys (idempotency_key, request_method, request_path);
...
CREATE INDEX idx_idempotency_keys_key_method_path ON idempotency_keys (idempotency_key, request_method, request_path);
